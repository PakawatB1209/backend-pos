...
//     // 2. รันเลขที่ใบสั่งซื้ออัตโนมัติ (SO-YYYYMM-XXXX)
//     const date = new Date();
...
//     // 3. คำนวณยอดเงิน (Math Calculation)
//     // ใช้สูตร: $$GrandTotal = \sum (Qty \times UnitPrice) - DiscountTotal$$
//     let subTotal = 0;
...
//         // ✅ บันทึกสเปคจากการ Custom ที่ส่งมาจากหน้าบ้าน
